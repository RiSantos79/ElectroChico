  ...
  return (
    <ResponsiveContainer width="100%" height={280}>
      <ComposedChart data={formatted}>
        ...
        <Legend {...CHART_LEGEND} />
        <Bar yAxisId="left" dataKey="total" name="Vendas" fill={GRAFANA_COLORS[2]} radius={[2, 2, 0, 0]} maxBarSize={22} />
        <Line yAxisId="right" type="monotone" dataKey="visits" name="Visitas" stroke={GRAFANA_COLORS[1]} strokeWidth={1.5} dot={false} />
      </ComposedChart>
    </ResponsiveContainer>
  );
}
